...
class DatasetGenerator(object):
    _OOD_SAMPLES_MD5 = "54ac377793b3aa2910b106f128aa9142"   # 54ac377793b3aa2910b106f128aa9142
    ...
    def build_full_train_data(
        self,
        canaries_dir: pathlib.Path = None,
    ) -> Dataset:
    ...
    def _build_train_canary_data(self, canaries_dir: pathlib.Path = None) -> typing.Tuple[torch.Tensor, torch.Tensor]:
        ...
        if self._canary_type == CanaryType.CLEAN:
            ...
            # visulize 10 images in self._ood_xs
            # import pdb; pdb.set_trace()
            # import torchvision.utils as vutils 
            # images = self._ood_xs[:40].float() / 255.0
            # grid_img = vutils.make_grid(images, nrow=5)
            # vutils.save_image(grid_img, 'ood.png')
            return canary_features, canary_targets
        elif self._canary_type == CanaryType.SSL_WORST_CASE:
